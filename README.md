...
## Challenge Timeline and Process Description
 ...
 1. Friday night, after project pitch, we're expecting the participant teams interested in executing on the project to submit an [issue](https://github.com/JinjunXiong/TechTogether2020/issues) to this GitHub repo with the name of the team in the title of the [issue](https://github.com/JinjunXiong/TechTogether2020/issues). Here is [an example of such an issue](https://github.com/JinjunXiong/TechTogether2020/issues/1) you should create. The body of the issue should contain the name of the participants and the GitHub repository where all code, results and analysis will be deposited. We expect this step to be completed by **Saturday 9am, Feb 1st, 2020**. At this point, we will distribute about 50 abstracts that need to be included in the experiments. Also we will distribute a set of 100 abstracts for those who want to work on the bonus component. 
